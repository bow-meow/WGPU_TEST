...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32>{
	...
	return vec4<f32>(quad_sample.c0.rgb, mix(quad_sample.c0.a, min(min(min(quad_sample.c0.a, quad_sample.c1.a), min(quad_sample.c2.a, quad_sample.c3.a)), quad_sample.c4.a), data.strength));
}