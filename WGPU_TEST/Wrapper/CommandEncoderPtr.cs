...
namespace WgpuWrappersSilk.Net
{
    public readonly unsafe struct CommandEncoderPtr
    {
        ...
        public ComputePassEncoderPtr BeginComputePass(ReadOnlySpan<ComputePassTimestampWrite> timestampWrites, string? label = null)
        {
            ...
            var timestampWritesPtr = stackalloc Silk.NET.WebGPU.ComputePassTimestampWrite[timestampWrites.Length];
        ...
        public RenderPassEncoderPtr BeginRenderPass(
            ...
            ReadOnlySpan<RenderPassTimestampWrite> timestampWrites = default, 
            ...
            string? label = null)
        {
            ...
            var timestampWritesPtr = stackalloc Silk.NET.WebGPU.RenderPassTimestampWrite[timestampWrites.Length];
